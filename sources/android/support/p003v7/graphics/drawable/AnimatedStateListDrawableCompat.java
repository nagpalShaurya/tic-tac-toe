...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0266R.styleable.AnimatedStateListDrawableCompat);
        setVisible(a.getBoolean(C0266R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.setVariablePadding(a.getBoolean(C0266R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, state.mVariablePadding));
        state.setConstantSize(a.getBoolean(C0266R.styleable.AnimatedStateListDrawableCompat_android_constantSize, state.mConstantSize));
        state.setEnterFadeDuration(a.getInt(C0266R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, state.mEnterFadeDuration));
        state.setExitFadeDuration(a.getInt(C0266R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, state.mExitFadeDuration));
        setDither(a.getBoolean(C0266R.styleable.AnimatedStateListDrawableCompat_android_dither, state.mDither));
    }
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        int type;
        Theme theme2 = theme;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme2, attrs, C0266R.styleable.AnimatedStateListDrawableTransition);
        int fromId = a.getResourceId(C0266R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int toId = a.getResourceId(C0266R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        Drawable dr = null;
        int drawableId = a.getResourceId(C0266R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        if (drawableId > 0) {
            dr = AppCompatResources.getDrawable(context, drawableId);
        } else {
            Context context2 = context;
        }
        boolean reversible = a.getBoolean(C0266R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        a.recycle();
    ...
    private int parseItem(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        int next;
        int type;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0266R.styleable.AnimatedStateListDrawableItem);
        int keyframeId = a.getResourceId(C0266R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        Drawable dr = null;
        int drawableId = a.getResourceId(C0266R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
        if (drawableId > 0) {
            dr = AppCompatResources.getDrawable(context, drawableId);
        }
        a.recycle();
