...
class AlertController {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    C02451 r1 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    ...
                    C02462 r12 = new CursorAdapter(this.mContext, cursor, false) {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0266R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0266R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0266R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0266R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0266R.styleable.AlertDialog, C0266R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0266R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0266R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0266R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0266R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0266R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0266R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0266R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0266R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0266R.C0268id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0266R.C0268id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0266R.C0268id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0266R.C0268id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0266R.C0268id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0266R.C0268id.topPanel);
        View customContentPanel = customPanel.findViewById(C0266R.C0268id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0266R.C0268id.buttonPanel);
        ...
        if (hasButtonPanel) {
            ...
            View spacer = contentPanel.findViewById(C0266R.C0268id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0266R.C0268id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0266R.C0268id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0266R.C0268id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0266R.C0268id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0266R.C0268id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0266R.C0268id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0266R.C0268id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0266R.C0268id.scrollView);
