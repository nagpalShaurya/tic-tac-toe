...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0266R.styleable.PopupWindow, defStyleAttr, defStyleRes);
        if (a.hasValue(C0266R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0266R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(a.getDrawable(C0266R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
    }
