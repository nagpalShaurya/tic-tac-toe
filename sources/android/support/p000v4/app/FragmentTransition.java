...
class FragmentTransition {
    ...
    public static void calculateFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            addToFirstInLastOut(transaction, (C0084Op) transaction.mOps.get(opNum), transitioningFragments, false, isReordered);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) {
        if (transaction.mManager.mContainer.onHasView()) {
            for (int opNum = transaction.mOps.size() - 1; opNum >= 0; opNum--) {
                addToFirstInLastOut(transaction, (C0084Op) transaction.mOps.get(opNum), transitioningFragments, true, isReordered);
            }
        }
    }
    ...
    private static void addToFirstInLastOut(android.support.p000v4.app.BackStackRecord r22, android.support.p000v4.app.BackStackRecord.C0084Op r23, android.util.SparseArray<android.support.p000v4.app.FragmentTransition.FragmentContainerTransition> r24, boolean r25, boolean r26) {
        /*
            r0 = r22
            r1 = r23
            r2 = r24
