...
final class zzda extends zzeo<AuthResult, zza> {
    ...
    public zzda(@NonNull String str) {
        super(2);
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzdb(this)).build();
    }
    ...
    public final /* synthetic */ void zzab(zzdq zzdq, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzng = new zzew(this, taskCompletionSource);
        if (this.zznr) {
            zzdq.zzdh().zze(this.zzik, this.zznd.zzch(), this.zznc);
        } else {
            zzdq.zzdh().zza(new zzcc(this.zzik, this.zznd.zzch()), (zzdx) this.zznc);
        }
    }
}
