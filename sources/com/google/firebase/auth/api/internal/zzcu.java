...
final class zzcu extends zzeo<AuthResult, zza> {
    ...
    public zzcu(@NonNull EmailAuthCredential emailAuthCredential) {
        super(2);
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzcv(this)).build();
    }
    ...
    public final /* synthetic */ void zzz(zzdq zzdq, TaskCompletionSource taskCompletionSource) throws RemoteException {
