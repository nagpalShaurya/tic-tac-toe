...
final class zzcc extends zzeo<AuthResult, zza> {
    ...
    public zzcc(@NonNull PhoneAuthCredential phoneAuthCredential, @Nullable String str) {
        super(2);
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzcd(this)).build();
    }
    ...
    public final /* synthetic */ void zzr(zzdq zzdq, TaskCompletionSource taskCompletionSource) throws RemoteException {
