...
final class zzby extends zzeo<AuthResult, zza> {
    ...
    public zzby(@NonNull String str, @NonNull String str2, @Nullable String str3) {
        super(2);
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzbz(this)).build();
    }
    ...
    public final /* synthetic */ void zzp(zzdq zzdq, TaskCompletionSource taskCompletionSource) throws RemoteException {
