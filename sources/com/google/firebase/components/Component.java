...
public final class Component<T> {
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m31of(Class<T> anInterface, T value) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m32of(T value, Class<T> anInterface, Class<? super T>... additionalInterfaces) {
