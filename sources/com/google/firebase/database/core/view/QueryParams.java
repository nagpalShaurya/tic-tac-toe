...
public class QueryParams {
    ...
    static /* synthetic */ class C05031 {
        ...
        static final /* synthetic */ int[] f47xa04b6c33 = new int[ViewFrom.values().length];

        static {
            try {
                f47xa04b6c33[ViewFrom.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f47xa04b6c33[ViewFrom.RIGHT.ordinal()] = 2;
    ...
    public Map<String, Object> getWireProtocolParams() {
        ...
        if (num != null) {
            ...
            int i = C05031.f47xa04b6c33[viewFromToAdd.ordinal()];
            String str2 = VIEW_FROM;
            if (i == 1) {
                queryObject.put(str2, str);
            } else if (i == 2) {
                queryObject.put(str2, "r");
            }
        }
    ...
    public static QueryParams fromQueryObject(Map<String, Object> map) {
        QueryParams params = new QueryParams();
        String str = LIMIT;
        params.limit = (Integer) map.get(str);
        String str2 = INDEX_START_VALUE;
        if (map.containsKey(str2)) {
            params.indexStartValue = normalizeValue(NodeUtilities.NodeFromJSON(map.get(str2)));
        ...
        Object indexStartValue2 = INDEX_END_VALUE;
        if (map.containsKey(indexStartValue2)) {
            params.indexEndValue = normalizeValue(NodeUtilities.NodeFromJSON(map.get(indexStartValue2)));
        ...
        if (viewFrom2 != null) {
            params.viewFrom = viewFrom2.equals(str) ? ViewFrom.LEFT : ViewFrom.RIGHT;
        }
