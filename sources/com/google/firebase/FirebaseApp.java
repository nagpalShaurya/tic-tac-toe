...
import com.google.firebase.components.Component.C03731;
...
public class FirebaseApp {
    ...
    private FirebaseApp(Context applicationContext, String name, FirebaseOptions options) {
        ...
        List zza2 = C03731.zza(applicationContext).zza();
        this.zzl = new zzf(zzh, zza2, Component.m32of(applicationContext, Context.class, new Class[0]), Component.m32of(this, FirebaseApp.class, new Class[0]), Component.m32of(options, FirebaseOptions.class, new Class[0]));
        ...
        for (String str : iterable) {
            ...
            if (z) {
                try {
                    ...
                    Log.wtf(str2, "Firebase API initialization failure.", e3);
                } catch (IllegalAccessException e4) {
                    StringBuilder sb4 = new StringBuilder("Failed to initialize ");
                    sb4.append(str);
                    Log.wtf(str2, sb4.toString(), e4);
                }
            }
