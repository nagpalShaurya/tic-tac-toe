...
interface zzxi {
    ...
    <T> T zza(zzxj<T> zzxj, zzuz zzuz) throws IOException;

    <T> void zza(List<T> list, zzxj<T> zzxj, zzuz zzuz) throws IOException;

    <K, V> void zza(Map<K, V> map, zzwm<K, V> zzwm, zzuz zzuz) throws IOException;

    @Deprecated
    <T> T zzb(zzxj<T> zzxj, zzuz zzuz) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzxj<T> zzxj, zzuz zzuz) throws IOException;
