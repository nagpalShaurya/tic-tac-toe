...
interface zzyw {
    ...
    void zza(int i, zzud zzud) throws IOException;

    <K, V> void zza(int i, zzwm<K, V> zzwm, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxj zzxj) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxj zzxj) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxj zzxj) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzxj zzxj) throws IOException;
