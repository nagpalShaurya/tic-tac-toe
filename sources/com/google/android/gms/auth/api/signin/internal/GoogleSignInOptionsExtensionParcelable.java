...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo7664id = 3)
    private Bundle mBundle;
    @Field(getter = "getType", mo7664id = 2)
    private int mType;
    @VersionField(mo7670id = 1)
    private final int versionCode;

    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) int i2, @Param(mo7667id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
