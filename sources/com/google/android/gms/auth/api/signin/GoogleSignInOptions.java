...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo7664id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo7664id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo7664id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo7664id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo7664id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo7664id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo7664id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo7664id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) ArrayList<Scope> arrayList, @Param(mo7667id = 3) Account account, @Param(mo7667id = 4) boolean z, @Param(mo7667id = 5) boolean z2, @Param(mo7667id = 6) boolean z3, @Param(mo7667id = 7) String str, @Param(mo7667id = 8) String str2, @Param(mo7667id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
