...
public class Feature extends AbstractSafeParcelable {
    ...
    @Field(getter = "getName", mo7664id = 1)
    private final String name;
    @Field(getter = "getOldVersion", mo7664id = 2)
    @Deprecated
    private final int zzk;
    @Field(defaultValue = "-1", getter = "getVersion", mo7664id = 3)
    ...
    @Constructor
    public Feature(@Param(mo7667id = 1) String str, @Param(mo7667id = 2) int i, @Param(mo7667id = 3) long j) {
        this.name = str;
        this.zzk = i;
        this.zzl = j;
    }
