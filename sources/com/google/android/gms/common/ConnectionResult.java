...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo7664id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo7664id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo7664id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) int i2, @Param(mo7667id = 3) PendingIntent pendingIntent, @Param(mo7667id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
