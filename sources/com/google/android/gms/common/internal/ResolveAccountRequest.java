...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo7664id = 3)
    private final int zaoz;
    @Field(getter = "getSignInAccountHint", mo7664id = 4)
    private final GoogleSignInAccount zapa;
    @Field(getter = "getAccount", mo7664id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) Account account, @Param(mo7667id = 3) int i2, @Param(mo7667id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zale = i;
        this.zax = account;
        this.zaoz = i2;
