...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo7664id = 4)
    @Deprecated
    private final Scope[] zanx;
    @Field(getter = "getButtonSize", mo7664id = 2)
    private final int zapc;
    @Field(getter = "getColorScheme", mo7664id = 3)
    private final int zapd;

    @Constructor
    SignInButtonConfig(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) int i2, @Param(mo7667id = 3) int i3, @Param(mo7667id = 4) Scope[] scopeArr) {
        this.zale = i;
        this.zapc = i2;
        this.zapd = i3;
        this.zanx = scopeArr;
