...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) int i2, @Param(mo7667id = 3) int i3, @Param(mo7667id = 4) String str, @Param(mo7667id = 5) IBinder iBinder, @Param(mo7667id = 6) Scope[] scopeArr, @Param(mo7667id = 7) Bundle bundle, @Param(mo7667id = 8) Account account, @Param(mo7667id = 10) Feature[] featureArr, @Param(mo7667id = 11) Feature[] featureArr2, @Param(mo7667id = 12) boolean z) {
        this.version = i;
        this.zzdg = i2;
        this.zzdh = i3;
