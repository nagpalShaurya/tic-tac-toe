...
public class Logger {
    ...
    @KeepForSdk
    /* renamed from: v */
    public void mo7720v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    @KeepForSdk
    /* renamed from: d */
    public void mo7715d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public void mo7718i(String str, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: w */
    public void mo7721w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo7717e(String str, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr));
    }

    @KeepForSdk
    /* renamed from: e */
    public void mo7716e(String str, Throwable th, @Nullable Object... objArr) {
