...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWidth", mo7664id = 3)
    private final int zand;
    @Field(getter = "getHeight", mo7664id = 4)
    private final int zane;
    @Field(getter = "getUrl", mo7664id = 2)
    private final Uri zanf;

    @Constructor
    WebImage(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) Uri uri, @Param(mo7667id = 3) int i2, @Param(mo7667id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;
