...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @Field(getter = "getColumns", mo7664id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @Field(getter = "getWindows", mo7664id = 2)
    private final CursorWindow[] zalr;
    @Field(getter = "getStatusCode", mo7664id = 3)
    private final int zals;
    @Field(getter = "getMetadata", mo7664id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo7667id = 1000) int i, @Param(mo7667id = 1) String[] strArr, @Param(mo7667id = 2) CursorWindow[] cursorWindowArr, @Param(mo7667id = 3) int i2, @Param(mo7667id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;
