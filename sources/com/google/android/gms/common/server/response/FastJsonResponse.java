...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @VersionField(getter = "getVersionCode", mo7670id = 1)
        private final int zale;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeIn", mo7664id = 2)
        protected final int zapq;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeInArray", mo7664id = 3)
        protected final boolean zapr;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeOut", mo7664id = 4)
        protected final int zaps;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeOutArray", mo7664id = 5)
        protected final boolean zapt;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getOutputFieldName", mo7664id = 6)
        protected final String zapu;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo7664id = 7)
        protected final int zapv;
        protected final Class<? extends FastJsonResponse> zapw;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getConcreteTypeName", mo7664id = 8)
        private final String zapx;
        private zak zapy;
        /* access modifiers changed from: private */
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getWrappedConverter", mo7664id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zapz;

        @Constructor
        Field(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) int i2, @Param(mo7667id = 3) boolean z, @Param(mo7667id = 4) int i3, @Param(mo7667id = 5) boolean z2, @Param(mo7667id = 6) String str, @Param(mo7667id = 7) int i4, @Param(mo7667id = 8) String str2, @Param(mo7667id = 9) zaa zaa) {
            this.zale = i;
            this.zapq = i2;
            this.zapr = z;
            this.zaps = i3;
