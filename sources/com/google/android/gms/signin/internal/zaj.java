...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo7664id = 2)
    private final ConnectionResult zadh;
    @VersionField(mo7670id = 1)
    private final int zale;
    @Field(getter = "getResolveAccountResponse", mo7664id = 3)
    private final ResolveAccountResponse zasb;

    @Constructor
    zaj(@Param(mo7667id = 1) int i, @Param(mo7667id = 2) ConnectionResult connectionResult, @Param(mo7667id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zale = i;
